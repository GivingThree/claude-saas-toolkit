...
description: Create a SessionStart hook for Claude Code on the web. Use when setting up a repository for web sessions or creating a hook to install dependencies so tests and linters work.
---
